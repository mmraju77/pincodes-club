...
export default function GuidesHubPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 space-y-12 min-h-screen">
      ...
      {/* Categories Grid (Now Clickable Links) */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {categories.map((cat, index) => (
          <Link href={cat.link} key={index} className={`block bg-slate-900/50 p-8 rounded-2xl border border-slate-800 transition-all cursor-pointer group ${cat.color}`}>
