...
const ALL_INDIA_DISTRICTS = {
  ...
  'andhra-pradesh': [
    ...
    "Visakhapatnam", "Vizianagaram", "Bapatla", "Dr. B.R. Ambedkar Konaseema", 
    "East Godavari", "Eluru", "Guntur", "Kakinada", "Krishna", "Markapuram", 
    "NTR", "Palnadu", "Polavaram", "Prakasam", "Sri Potti Sriramulu Nellore", 
    "West Godavari", "Rayalaseema", "Ananthapuramu", "Annamayya", "Chittoor", 
    "YSR Kadapa", "Kurnool", "Nandyal", "Sri Sathya Sai", "Tirupati"
  ],
